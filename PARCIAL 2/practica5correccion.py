# -*- coding: utf-8 -*-
"""
Created on Fri Feb 27 10:39:05 2026
...
def compararImagenes(pr,d,pr2,d2):
    bf= cv2.BFMatcher()
    coincidencias= bf.knnMatch(d,d2, k=2)
    caracteristicas= []
...
imagen1 = vent.fileopenbox(msg='Abrir imagen', title='Abrir imagen', default='', filetypes=['*.jpg'])
img,pr,d = extraercaracteristicas(imagen1)
imagen2 = vent.fileopenbox(msg='Abrir imagen', title='Abrir imagen', default='', filetypes=['*.jpg'])
